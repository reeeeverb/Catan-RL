...
class Front():
    ...
    def draw_tile(self,x,y,terrain,index):
        screen = self.screen
        tile = sprites.Terrain_Tile(screen,terrain,x,y,index)
    ...
    def draw_board(self,x,y,board):
        ...
        draw_tile(x,y,terrains[0],0)
        draw_tile(x+100,y,terrains[1],1)
        draw_tile(x+200,y,terrains[2],2)
        draw_tile(x-50,y+75,terrains[3],3)
        draw_tile(x+50,y+75,terrains[4],4)
        draw_tile(x+150,y+75,terrains[5],5)
        draw_tile(x+250,y+75,terrains[6],6)
        draw_tile(x-100,y+150,terrains[7],7)
        draw_tile(x,y+150,terrains[8],8)
        draw_tile(x+100,y+150,terrains[9],9)
        draw_tile(x+200,y+150,terrains[10],10)
        draw_tile(x+300,y+150,terrains[11],11)
        draw_tile(x-50,y+225,terrains[12],12)
        draw_tile(x+50,y+225,terrains[13],13)
        draw_tile(x+150,y+225,terrains[14],14)
        draw_tile(x+250,y+225,terrains[15],15)
        draw_tile(x,y+300,terrains[16],16)
        draw_tile(x+100,y+300,terrains[17],17)
        draw_tile(x+200,y+300,terrains[18],18)
